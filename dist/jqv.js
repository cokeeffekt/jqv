...
(function () {
  ...
  domdiff = function (diff, applyDiff) {

    return {
      diff: diff,
      applyDiff: applyDiff
    };
  }(domdiff_diff, domdiff_applyDiff);
  window.jef = window.jef || {};
  window.jef.domdiff = domdiff;
}());
